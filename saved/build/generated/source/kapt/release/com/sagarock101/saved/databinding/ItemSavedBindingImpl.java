...
public class ItemSavedBindingImpl extends ItemSavedBinding  {
    ...
    public ItemSavedBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ItemSavedBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.article == variableId) {
            ...
            setViewModel((com.sagarock101.saved.viewmodel.SavedNewsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.sagarock101.saved.viewmodel.SavedNewsViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            com.sagarock101.saved.binding.SavedNewsBindingKt.setImage(this.ivNewsImg, articleUrlToImage);
            com.sagarock101.saved.binding.SavedNewsBindingKt.bindSourceAndTime(this.tvNewsSource, articleSourceName, articlePublishedAt);
